...
% Last Modified by GUIDE v2.5 14-Jan-2022 11:29:20
...
name = get(handles.nameS,'String');
age = get(handles.ageS,'String');
str = strcat("My name is ",name,". I'm ",age," years old.");
set(handles.outS,'String',str);
...
set(handles.nameS,'String','');
set(handles.ageS,'String','');
set(handles.outS,'String','');
...
function ageS_Callback(hObject, eventdata, handles)
% hObject    handle to ageS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ageS as text
%        str2double(get(hObject,'String')) returns contents of ageS as a double


% --- Executes during object creation, after setting all properties.
function ageS_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ageS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
